...
export interface paths {
    ...
    "/admin/contact-messages/{id}/impact": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
