...
class Stocking extends Component {
	...
	s5.2-1.7,5.2-7.8S41.1,16.1,41.1,16.1z"></path>
                    <path fill="#DCDBDB" d="M40.2,7c0,0-6.8,0.3-6.8,6.8s7.7,6.5,7.7,6.5h44c0,0,5.5-0.6,5.5-6.7S83.2,7,83.2,7H40.2z"></path>
                    <path fill="#C95964" d="M85.1,78.9c0,0-17.2-0.3-17.2,18.2l0,0C81.7,94.9,84.6,84.8,85.1,78.9z"></path>
	...
	L63.2,55.1z M63.2,58l-1.3,1.7h0.6l0.7-0.8l0.7,0.8h0.6L63.2,58z"></path>
                </svg>
            </div>
        )
    }
