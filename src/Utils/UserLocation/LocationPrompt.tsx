                ...
                >
                    ...
                    <Modal.Body>
                        <div className="LocationPromptCustomModalBody" id={`location-prompt-custom-modal-body-${this.props.theme.toLowerCase()}`}>
                            ...
                            <p>Clicking "Ok" will launch a location prompt in your browser window and you will be asked if you want to allow 406santaflyover.org to access your device’s location.</p>
