// docs/site.md section 8.4. The `expedition` theme: the legacy Retro style, parchment tones. The style array,
...
// the legacy tracker's Retro theme, carried over unchanged.
