...
export const alertsSignupHelp: string;
export const alertsSignupInput: string;
export const alertsSignupPending: string;
export const alertsSignupRow: string;
export const alertsSignupRowAction: string;
export const alertsSignupRowAddress: string;
