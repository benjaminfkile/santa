            ...
            <div className="PreShow">
                ...
                <div className="preshow-info-card">
                    <div className="preshow-info-card-header">
                        <p id="preshow-info-card-header-p1">Looks like Semi Santa is still at the North Pole.</p>
                    ...
                    <div className="preshow-info-card-message">
                        {!message && <p>Important updates about Semi Santa's drive around town will show up here.</p>}
                        {message && <p>{message}</p>}
                    </div>
